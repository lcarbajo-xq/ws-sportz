      ...
      <div className='flex-1 overflow-y-auto p-4 space-y-3'>
        {isLoading ? (
          ...
          commentaries.map((commentary) => {
            const metadataLabel =
              formatMetadata(commentary.metadata ?? {}) ?? ''
                  ...
                  <div className='pb-4'>
                    ...
                    {(commentary.actor || commentary.team) && (
                      <div className='text-sm font-semibold text-gray-700 mb-1'>
                        {commentary.actor && (
                          <span className=''>{commentary.actor}</span>
                        )}
                        {commentary.actor && commentary.team && (
                          <span className=''> · </span>
                        )}
                        {commentary.team && (
                          <span className=''>{commentary.team}</span>
                        )}
                      </div>
                    )}
